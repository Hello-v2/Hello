...
<div class="container-fluid">
    <div class="neo-card mb-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="/admin/questions/create<?php echo (isset($exam) && $exam) ? '?exam_id=' . $exam['id'] : ''; ?>" class="neo-btn neo-btn-primary">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo isset($question['exam_title']) ? htmlspecialchars($question['exam_title']) : ''; ?></td>
