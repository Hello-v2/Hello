...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="/admin/questions/store" method="post" id="questionForm" onsubmit="return validateQuestionForm(event)">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateQuestionForm(event) {
            ...
            document.querySelectorAll('input[name="options[]"], input[name="drag_items[]"], input[name="drop_zones[]"], input[name="correct_options[]"], input[name="correct_option"]').forEach(input => {
